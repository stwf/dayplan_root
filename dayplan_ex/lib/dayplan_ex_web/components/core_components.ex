defmodule DayplanExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DayplanExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DayplanExWeb.Gettext, "errors", msg, opts)
    end
  end
